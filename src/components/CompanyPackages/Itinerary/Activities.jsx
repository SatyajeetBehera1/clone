...
export default function Activities() {
  return (
    <div className="max-w-xl mx-auto p-2">
      <div className="mb-6">
        {/* Activity Title */}
        <p className="text-xl font-bold mb-2">Activity in Goa <span className="text-gray-600">7 Hrs</span></p>
      </div>
      <div className="bg-gray-100 rounded-lg shadow-md p-6 flex">
        ...
        <div className="w-2/3 pl-6">
          <h3 className="text-base font-semibold mb-2">North Goa Sightseeing with Free Evening Catamaran Cruise and Private Transfer</h3>
